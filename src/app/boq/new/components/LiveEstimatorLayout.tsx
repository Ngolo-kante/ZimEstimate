          ...
          <div className="hidden lg:block">
            <div className="sticky top-24 py-8 h-[calc(100vh-8rem)]">
              {heroIllustration ? (
                ...
                <div className="w-full h-full rounded-2xl bg-[var(--wiz-surface-muted)] border border-slate-200 flex items-center justify-center flex-col text-slate-400">
                  <div className="p-4 bg-white shadow-sm rounded-xl mb-4">
                    <span className="text-xs font-bold uppercase tracking-wider" style={{ color: 'var(--wiz-jade)' }}>Visual Guide</span>
                  </div>
